        ...
        <div className='container mx-auto flex px-5 py-24 flex-col md:flex-row items-center'>
          <div
            ...
            <p className='mb-8 leading-relaxed'>
              An office worker with a bad case of insomnia teams up with a rebel soap maker and
              insanity ensues.
            </p>
            <a href="https://imdb.com/title/tt0137523"
              className="text-white bg-yellow-400 border-0 py-2 px-6 rounded-lg text-lg hover:bg-yellow-500">
              Learn more</a>
          </div>
